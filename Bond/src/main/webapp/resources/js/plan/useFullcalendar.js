...
/* 일정 추가(insertOne) */
// dateClick 시 해당 날짜 데이터를 insertBody에 보내고 insertBody를 열음
...
function fillUpdateModal(){
    ...
    if(period.length === 22) {
        ...
        input2EndTime.value = input2StartTime.value;
    }
