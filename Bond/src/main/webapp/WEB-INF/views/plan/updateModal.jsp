...
<div id="updateModal" class="closed">
  ...
  <div id="updateWindow">
    ...
    <div id="updateBody">
      <div id="inputTitleBox">
        <input type="text" id="input2Title" placeholder="일정 제목">
      </div>

      <div id="inputContentBox">
        <textarea id="input2Content" placeholder="일정 설명"></textarea>
      </div>
      ...
      <div id="inputDateBox">
        ...
        <div id="startBox" class="dateBoxRow">
          ...
          <input type="date" id="input2StartDate">
          <input type="time" id="input2StartTime">
        </div>

        <div id="endBox" class="dateBoxRow">
          <div id="endBoxText">종료</div>
          <input type="date" id="input2EndDate">
          <input type="time" id="input2EndTime">
        </div>

        <div id="allDayBox" class="dateBoxRow">
          <input type="checkbox" id="input2Checkbox">
