...
- 내 프로필, 초대이력, 유료상품 구매 및 다운로드 내역, 무료 스티커 다운로드 내역, 
  본드게임 계정이 모두 사라지고, 애드포스트 미디어 등록이 해제되며 복구가 불가능합니다.
                            
- 참여 중인 모든 본드와 페이지에서 탈퇴됩니다. 본드 서비스 내에서 작성한 콘텐츠를 
  삭제하거나 수정할 수 없으니, 원하시면 계정 삭제 전에 지우거나 수정하시기 바랍니다.
                            
- 본드 파트너센터를 이용중인 경우, 본드 계정 삭제 시 본드 파트너센터에서도 탈퇴가 진행됩니다.
                            
* 가입한 본드 중 하나만 탈퇴하고 싶다면?
  탈퇴하고 싶은 본드에 들어가서 [본드 탈퇴하기]를 선택하세요.
                        </pre>
                    </div>
