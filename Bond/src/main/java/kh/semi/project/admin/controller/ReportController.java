...
import kh.semi.project.admin.model.service.ReportService;
...
public class ReportController {
	...
	// 임시 신고 페이지1로 이동
	@GetMapping("/admin/tempReport")
	public String goTempReport() {
		return "admin/report/tempReport";
	}
	...
	// 신고하기 페이지로 정보 전달
	@GetMapping("/admin/report/{target}/{input}")
	...
	// 신고하기
	@PostMapping("/admin/report/{target}/{targetNoStr}/{reasonCode}")
